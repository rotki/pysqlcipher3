...
class AggregateTests(unittest.TestCase):
    ...
    def test_AggrNoStep(self):
        ...
        self.assertEqual(str(cm.exception), "user-defined aggregate's 'step' method not defined")
    ...
    def test_AggrNoFinalize(self):
        ...
        with self.assertRaises(sqlite.OperationalError) as cm:
            ...
            val = cur.fetchone()[0]
        self.assertEqual(str(cm.exception), "user-defined aggregate's 'finalize' method not defined")
