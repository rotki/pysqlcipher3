...
class RegressionTests(unittest.TestCase):
    ...
    def test_NullCharacter(self):
        # Issue #21147
        con = sqlite.connect(":memory:")
        self.assertRaises(sqlite.ProgrammingError, con, "\0select 1")
        self.assertRaises(sqlite.ProgrammingError, con, "select 1\0")
        cur = con.cursor()
        self.assertRaises(sqlite.ProgrammingError, cur.execute, " \0select 2")
        self.assertRaises(sqlite.ProgrammingError, cur.execute, "select 2\0")
